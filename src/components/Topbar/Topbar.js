        ...
        <nav style={navStyle} className="navbar navbar-expand-md fixed-top navbar-light">
            <div className="container">
                <Link className="navbar-brand" to="/">
                    <img src={logo} alt="Volunteer Network" width="170px" className="py-2 px-4" />
                </Link>
                ...
                <div className="collapse navbar-collapse text-center" id="nava">
                    <ul className="navbar-nav ml-auto">
                        <Link style={linkStyle} to="/my-registrations" className="shadow nav-item m-2 my-md-0">
                            <button className="nav-link btn btn-block btn-success text-white">Registered Events</button>
                        </Link>
                        <Link style={linkStyle} to="/admin" className="nav-item shadow m-2 my-md-0">
                            <button className="nav-link btn btn-block text-white btn-danger">Admin</button>
                        </Link>
                        {
                            user.signed ?
                            <button onClick={signOutAll} className="nav-item btn btn-primary m-2  my-md-0 text-white shadow">Sign out <br/> {user.name}</button> :
