...
const Register = () => {
    ...
    function subForm(e) {
        ...
        // adding user
        fetch('https://thawing-beyond-31671.herokuapp.com/register', {
            method: 'POST',
        ...
        .then(data => {
            if(data){
                document.getElementById('register').innerHTML = '<h2 class="text-center text-success mt-5 pt-5">Registered Successfully</h2><h4 class="text-center">See all of registered events in the "Registered Events" page.</h4><h4 class="text-center text-primary">Thank for being a member of this great community... 😊</h4>'
            }
        })
    }

    return (
        <section id="register" className="container py-5 mt-5 bg-warning">
            <form style={formStyle} method="POST" onSubmit={subForm} className="shadow py-3 px-4 mt-5 border rounded bg-light">
